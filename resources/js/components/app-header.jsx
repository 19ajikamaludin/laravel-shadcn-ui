...
import { ItemIcon } from '@/components/nav-main'
...
import { cn, filterAllowedMenu } from '@/lib/utils'
                            ...
                            <NavigationMenuList className="flex h-full items-stretch space-x-2">
                                {menus.map((item, index) => (
                                    ...
                                    >
                                        <Link
                                            href={item.route}
                                            className={cn(navigationMenuTriggerStyle(), item.active && activeItemStyles, 'h-9 cursor-pointer px-3')}
                                        >
                                            {item.icon && <ItemIcon icon={item.icon} />}
                                            {item.title}
                                        </Link>
